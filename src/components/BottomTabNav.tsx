...
import { Home, Calendar, User, LogOut, Users, Plus, Settings, Building2, BookOpen, Car, CalendarOff } from 'lucide-react';
...
const TAB_ITEMS: TabItem[] = [
  ...
  { icon: CalendarOff, label: 'Afwezig', path: '/availability', roles: ['instructor'] },
